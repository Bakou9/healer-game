namespace Healer.Ui
{
    ...
    public sealed class Navigator
    {
        ...
        /// <summary>Fiches de personnages (D-084) : les statistiques de chacun, hors combat.</summary>
        public bool OpenRoster()
        {
            if (Screen != AppScreen.MainMenu) return false;
            Screen = AppScreen.Roster;
            return true;
        }

        public bool BackToMenu()
        {
            if (Screen != AppScreen.LevelSelect && Screen != AppScreen.Workshop && Screen != AppScreen.Settings && Screen != AppScreen.Credits && Screen != AppScreen.Gallery && Screen != AppScreen.Roster) return false;
        ...
        {
            if (Screen == AppScreen.MainMenu || Screen == AppScreen.Workshop || Screen == AppScreen.Settings || Screen == AppScreen.Credits || Screen == AppScreen.Gallery || Screen == AppScreen.Roster || !unlocked || string.IsNullOrEmpty(levelId)) return false;
