...
- [x] Style retenu (provisoire) : fantasy stylisée en formes vectorielles dessinées en code (aucun fichier d'image), fond sombre avec lueurs, accents lumineux par langage visuel (soin vert, bouclier bleu, poison violet, danger rouge, phase 2 orange), coins arrondis
- [x] Jetons de design partagés (`src/ui/layout.ts`) et briques réutilisables : panneaux, icônes de portrait et de sort, décor (`src/scenes/art/`)
