...
- [ ] Jets de particules pour soin, bouclier (avec anneau), poison, purge et impact, réutilisant les particules (Object Pool)
- [ ] Cohérents avec les états de la simulation (déclenchés par les événements de combat)
- [ ] Le Golem réagit : cœur qui pulse, s'emballe pendant un télégraphe, orange en phase 2 ; secousse d'écran brève sur l'attaque de zone et le changement de phase
