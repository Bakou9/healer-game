...
- [ ] Toucher un allié vivant le sélectionne (bordure jaune, « Cible : nom ») ; un allié K.O. ne se sélectionne pas
- [ ] Les sorts ciblés s'appliquent à l'allié sélectionné ; la sélection reste après un sort (re-soigner la même cible = 1 geste)
- [ ] Annulation évidente : retoucher la carte annule ; la sélection est abandonnée à la mort de l'allié
- [ ] Un sort ciblé sans sélection ne lance rien et affiche « Choisissez d'abord un allié ! » ; un sort de zone se lance sans cible
- [ ] Aucun ciblage automatique (préserve la décision centrale)
- [ ] Sensibilité de l'équilibre au délai de décision mesurée (voir revue)
