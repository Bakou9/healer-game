...
|---|---|---|---|---|---|---|
| [E13-T01](E13-T01-filet-de-non-regression-golden-equilibrage-donne.md) | Filet de non-régression : golden, équilibrage, données, architecture | Test | P0 | 1 | À faire | — |
...
| [E13-T04](E13-T04-depot-git-et-github.md) | Dépôt git et GitHub | Tech | P0 | 1 | À faire | — |
...
| [E13-T09](E13-T09-integration-continue-workflow-github-actions.md) | Intégration continue (workflow GitHub Actions) | Tech | P0 | 2 | À faire | E13-T04 |
<!-- TICKETS:END -->
