...
| Unity Hub | installation lancée | `winget install Unity.UnityHub` (autorisé par l'utilisateur) |
| Éditeur Unity 6 LTS + module Android | à installer via le Hub | plusieurs Go |
