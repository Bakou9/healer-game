...
export const SCENARIOS: Scenario[] = [
  ...
  scenario("bot-lent-seed7", (b) => runWithReferenceHealer(b, MAX_MS, { decisionEveryMs: 1500 }), [], 7),
  scenario("bot-sans-purge-seed7", (b) => runWithReferenceHealer(b, MAX_MS, { purge: false }), [], 7),
