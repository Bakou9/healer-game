...
| Tests C# (`core/Healer.Combat.Tests`) | 461 tests : conformité golden, règles, équilibrage de chaque boss et de chaque choix d'amélioration, progression, atelier, sauvegarde, navigation, entrées, mise en page |
